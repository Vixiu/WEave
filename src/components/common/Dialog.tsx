            ...
            <div className="pointer-events-none fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              >
                <motion.div
                  ...
                  className={cn(
                    "pointer-events-auto relative flex max-h-[calc(100vh-2rem)] w-full flex-col overflow-hidden rounded-xl border border-white/10 bg-surface/60 shadow-[0_16px_40px_rgba(0,0,0,0.6)] backdrop-blur-2xl outline-none focus:ring-0 focus:outline-none focus-visible:ring-0 focus-visible:outline-none",
                    SIZES[size],
                  )}
                >
